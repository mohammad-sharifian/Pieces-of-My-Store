...
(function ($, undefined) {
    ...
    $.fn.czMore = function (options) {
        ...
        return this.each(function () {
            ...
            var divPlus = '<i id="btnPlus"  class="fa fa-plus fa-lg text-success btnPlus" style="display: block"></i>';
            ...
            function loadMinus(recordset) {
                var divMinus = '<i id="btnMinus"  class="fa fa-times fa-lg text-danger btnMinus"></i>'
